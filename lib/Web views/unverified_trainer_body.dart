...
class UnVerifiedTrainerBody extends StatefulWidget {
  const UnVerifiedTrainerBody({super.key});

  @override
  State<UnVerifiedTrainerBody> createState() => _UnVerifiedTrainerBodyState();
}

class _UnVerifiedTrainerBodyState extends State<UnVerifiedTrainerBody> {
    ...
    return ScrollConfiguration(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            StreamBuilder(
                stream: AllUserScreenApi.unVerifiedTrainer(),
                builder: (BuildContext context, snapshot) {
                  ...
                  return Center(
                    child: ShowText.detailsText(
                        "UnVerified Trainer unavailable",
